...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ClaireGUO', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '發現新事物', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://richnote.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'AI,推薦,省錢,理財,優惠', // 网站关键词 英文逗号隔开
